    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6">
      <div className="w-full max-w-xs">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-light text-slate-200 tracking-wide">cal.hanif</h1>
        ...
        <div className="grid grid-cols-3 gap-3 mt-4">
          ...
          <button
            onClick={handleBack}
            className="aspect-square bg-slate-900 hover:bg-slate-800 text-slate-400 text-xl rounded-xl transition-colors"
          >
            ←
          </button>
        </div>
